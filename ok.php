...
?>
                ...
                $sql5="INSERT INTO fee VALUES ('$sname','$roomno',2000,'')";
                $result5=mysqli_query($con,$sql5);
                ...
                if($result2)
                {
                    ...
                    $sql6="DELETE FROM fee WHERE stroomno=$oroom AND stname=$oname";
                    ...
                    echo"<center>WRONG USERNAME,PLEASE TRY AGAIN</center>";
            exit;
